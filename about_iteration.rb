...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # => It process an operation on each members of the enumerable object and store 
    # the result of this operation in a "sum" variable. It return the final "sum" variable at the end
  end
  ...
  #
  # => To close the opened file at the end of the process (and free memory)
end
