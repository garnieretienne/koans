...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # > To protect against method name overwriting: a class 
    # may need a send method (ex: an 'EMail' class)
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # > We can redefine the way the class handle missing method calls
    #
    # NOTE:
    #
